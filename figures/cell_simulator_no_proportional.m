...
classdef cell_simulator_no_proportional
            ...
            if(obj.num_het>0)
                ...
                for i=1:obj.num_het
                    ...
                    if(~strcmp(obj.het.names{i},'act'))
                        ...
                        dxdt_het(i+obj.num_het)=(e./par(['n_',obj.het.names{i}])).*(x_het(i)./4.6689./7.9452e+04).*2.3605e4...
                            -l.*x_het(i+obj.num_het)+...
                            obj.het.extra_p_term(obj.het.names{i},x,ext_inp);
                    end
                end
