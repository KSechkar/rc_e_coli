...
sim.het.parameters('kb_anti')=300*10; % atcuator-annihilator binding rate constant
sim.het.parameters('c_sens')=100;
sim.het.parameters('a_sens')=50; % sensor gene transcription rate
sim.het.parameters('a_anti')=800*10; % annigilator transcription rate
sim.het.parameters('a_act')=400*10; % actuator transcription rate
